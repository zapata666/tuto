...
if ($_SESSION['permisos_acceso']=='Super Admin') { ?>
  ...
  <?php
	...
	elseif ($_GET["module"]=="stock_report") { ?>
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
        		...
        		<li class="active"><a href="?module=stock_report"><i class="fa fa-circle-o"></i> Registro de productos
            </a></li>
      		</ul>
    	</li>
    <?php
	...
	if ($_GET["module"]=="password") { ?>
		<li class="active">
			<a href="?module=password"><i class="fa fa-lock"></i> Cam|iar contraseña</a>
		</li>
	<?php
	}
...
if ($_SESSION['permisos_acceso']=='Almacen') { ?>
  ...
  elseif ($_GET["module"]=="stock_report") { ?>
    <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="?module=stock_inventory"><i class="fa fa-circle-o"></i> Stock  </a></li>
            <li class="active"><a href="?module=stock_report"><i class="fa fa-circle-o"></i> Registro  </a></li>
          </ul>
      </li>
    <?php
  }
    ...
    <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="?module=stock_inventory"><i class="fa fa-circle-o"></i> Stock  </a></li>
            <li><a href="?module=stock_report"><i class="fa fa-circle-o"></i> Registro  </a></li>
          </ul>
      </li>
    <?php
  }
